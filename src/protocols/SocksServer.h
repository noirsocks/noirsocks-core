...
class SocksServer : public ProtocolBase
{
public:
    ...
    SocksServer(const LocalService& service) : m_Conf(service) {}

    const LocalService& GetConf() {return m_Conf;}

    PCB_OnUdpData GetUdpWriteCallback() {return m_CBUdpWrite;}
